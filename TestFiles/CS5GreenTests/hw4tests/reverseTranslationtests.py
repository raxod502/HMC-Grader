...
class ReverseTest(unittest.TestCase):
  def testReverse1(self):
    ...
    self.assertTrue((temp == [('1', 'a'), ('2', 'b'), ('3', 'c or d')]) or (temp == [('1', 'a'), ('2', 'b'), ('3', 'd or c')]))

  def testReverse2(self):
    temp2 = sorted(hw.reverse({'dude!' : 'hello', 'later' : 'goodbye', 'stoked' : 'happy', 'ciao' : 'goodbye'}).items()); 
    self.assertTrue((temp2 == [('goodbye', 'ciao or later'), ('happy', 'stoked'), ('hello', 'dude!')]) or (temp2 == [('goodbye', 'later or ciao'), ('happy', 'stoked'), ('hello', 'dude!')]))
