...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
	...
	private static String reset = "Reset Picture";
	...
	private static String fiveThousand = "5000%";
	...
	private static final String seamCarving = "Seam Carving";
	private static final String luminosity  = "Luminosity";
	private static final String energy      = "Energy";
	private static final String showSeam    = "Show Seam";
	private static final String carve       = "Carve";
	private static final String caverMany   = "Carve Many";
	...
	private void setUpMenuBar() {
		...
		fiveThousandMenuItem = new JMenuItem(fiveThousand);
		...
		seamCarvingMenu 	 = new JMenu(seamCarving);
		luminosityMenuItem 	 = new JMenuItem(luminosity);
		energyMenuItem 	 	 = new JMenuItem(energy);
		showSeamMenuItem 	 = new JMenuItem(showSeam);
		carveMenuItem 		 = new JMenuItem(carve);
		carveManyMenuItem 	 = new JMenuItem(caverMany);		
		...
		fiveThousandMenuItem.addActionListener(this);
		...
		luminosityMenuItem.addActionListener(this);
		energyMenuItem.addActionListener(this);
		showSeamMenuItem.addActionListener(this);
		carveMenuItem.addActionListener(this);
		carveManyMenuItem.addActionListener(this);	
		...
		zoomMenu.add(fiveThousandMenuItem);
		...
		seamCarvingMenu.add(luminosityMenuItem);
		seamCarvingMenu.add(energyMenuItem);
		seamCarvingMenu.add(showSeamMenuItem);
		seamCarvingMenu.add(carveMenuItem);
		seamCarvingMenu.add(carveManyMenuItem);
		menuBar.add(seamCarvingMenu);
	...
	private void enableZoomItems() {
		...
		fiveThousandMenuItem.setEnabled(true);
	}
	...
	public void actionPerformed(ActionEvent a) {
		...
		if (a.getActionCommand().equals(fiveThousand)) {
			zoom(50.0);
			enableZoomItems();
		...
		if (a.getActionCommand().equals(luminosity)) {
			picture = picture.luminosity();
			createAndInitScrollingImage();
		}
		if (a.getActionCommand().equals(energy)) {
			picture = picture.energy();
			createAndInitScrollingImage();
		}
		if (a.getActionCommand().equals(showSeam)) {
			picture = picture.showSeam();
			createAndInitScrollingImage();
		}
		if (a.getActionCommand().equals(carve)) {
			picture = picture.carve();
			createAndInitScrollingImage();
		}		
		if (a.getActionCommand().equals(caverMany)) {
