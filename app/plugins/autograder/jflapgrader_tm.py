...
def runTests(cmdPrefix, testFile, timeLimit):
  ...
  try:
    #
    # The code below is modified from the tm_overall function (defined above)
    #
    ...
    # want to provide data back to the caller. This code is based on tm_checker
    #

    #Load the inputs
    tm_takingInput(testFile)
